...
test_v_size = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000]
average_time = []
false_pos = []
...
plt.plot(test_v_size, average_time)       # plot y vs x
plt.xlabel('(|V| + |E|) / 2')      # label x-axis
plt.ylabel('Time taken to compute 1000 graph hashes')      # label y-axis
plt.title('Graph Size (|V| + |E|) vs time taken')
plt.grid(True)       # optional grid

plt.plot(test_v_size, false_pos)       # plot y vs x
plt.xlabel('(|V| + |E|) / 2')      # label x-axis
plt.ylabel('Time taken to compute 1000 graph hashes')      # label y-axis
plt.title('Graph Size (|V| + |E|) vs time taken')
plt.grid(True)       # optional grid
plt.show()
# Isomorphism detection code for validity